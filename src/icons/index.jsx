  ...
  return (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <defs> </defs>{" "}
        <g id="Page-1" stroke-width="0.78" fill="none" fill-rule="evenodd">
          {" "}
          <g
...
export function UserRegisterIcon() {
  return (
    <svg
      width="1.5rem"
      viewBox="0 0 24 24"
